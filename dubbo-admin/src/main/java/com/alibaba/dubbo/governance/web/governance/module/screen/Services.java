...
public class Services extends Restful {
    ...
    public void index(Map<String, Object> context) {
        ...
        context.put("services", new ArrayList(services));
        ...
        if (StringUtils.isNotEmpty(keyword) && !"*".equals(keyword)) {
            ...
            context.put("services", new ArrayList(newList));
            context.put("providerServices", newProviders);
            context.put("consumerServices", newConsumers);
        }

        Collection servicesCalc= (Collection)context.get("services");
        Map<String, String> servicesDescMap = providerService.findServicesDescMap();
        Map<String, String> descMap = new HashMap<String, String>();
        for (Object s : servicesCalc) {
            String descs = "";
            String serviceKey = servicesDescMap.get(String.valueOf(s));
            if (serviceKey != null) {
                descs = serviceKey;
            }
            descMap.put(String.valueOf(s), descs);
        }
        context.put("descMap", descMap);
    }
